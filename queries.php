...
<body>
    <div class="flex flex-wrap">
        <div class="flex h-screen w-16 flex-col justify-between border-e bg-white">
            <div>
                ...
                <div class="border-t border-gray-100">
                    <div class="px-2">
                        <div class="py-4">
                            <a href="\" class="t group relative flex justify-center rounded  px-2 py-1.5 text-blue-700">
                        ...
                        <ul class="space-y-1 border-t border-gray-100 pt-4">
                            ...
                            <li>
                                <a href="\queries.php" class="group relative flex justify-center rounded px-2 py-1.5 text-gray-500 bg-blue-50 hover:bg-gray-50 hover:text-gray-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <div style="width:calc(100vw - 100px);" class="p-20">
            ...
            <div class="flex flex-col items-center justify-center mb-96">


                <ol class="  pl-5 space-y-1 list-decimal list-inside">
                    <li>
                        <a class="hover:underline text-lg" href="/query_1_input.php">List the names of all Engineers in Googong
                            Subdivision project located at Googong city</a>
                    </li>
                    <li>
                        <a class="hover:underline text-lg" href="/query_2_input.php">List the names of all Labour in Googong
